...
class TestLoginRegistration:
    ...
    def test_registration_new_login_successful_registration(self, new_user_data):
    ...
    def test_registration_empty_password_show_error(self, new_user_data):
        ...
        WebDriverWait(driver, 5).until(expected_conditions.visibility_of_element_located(TestLocators.Registration_Name))
        driver.find_element(*TestLocators.Registration_Name).send_keys(new_user_data[0])
        driver.find_element(*TestLocators.Registration_Email).send_keys(new_user_data[1])
    ...
    def test_login_main_page_select_successful_login(self, user_data):
    ...
    def test_login_profile_button_successful_login(self, user_data):
    ...
    def test_login_registration_form_successful_login(self, user_data):
        ...
        WebDriverWait(driver, 5).until(expected_conditions.visibility_of_element_located(TestLocators.Registration_Login_Button))
    ...
    def test_login_password_recovery_successful_login(self, user_data):
        ...
        WebDriverWait(driver, 5).until(expected_conditions.element_to_be_clickable(TestLocators.Registration_Login_Button))
        driver.find_element(*TestLocators.Registration_Login_Button).click()
